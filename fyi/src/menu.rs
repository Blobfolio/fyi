	...
	($name:literal, $desc:literal) => {
		SubCommand::with_name($name)
			...
			.arg(Arg::with_name("time")
				.short("t")
				.long("timestamp")
				.aliases(&["add-timestamp", "time", "timestamped"])
				.takes_value(false)
	...
	App::new("FYI")
		...
		.subcommand(
			clap_subcommand!("print", "Print a message without a prefix (or with a custom one).")
				...
				.arg(Arg::with_name("prefix_color")
					.short("c")
					.long("prefix-color")
					.takes_value(true)
					.default_value("199")
		...
		.subcommand(clap_subcommand!("crunched", "Crunched: Hello World"))
		.subcommand(clap_subcommand!("debug", "Debug: Hello World"))
		.subcommand(clap_subcommand!("done", "Done: Hello World"))
		.subcommand(
		...
		.subcommand(clap_subcommand!("info", "Info: Hello World"))
		.subcommand(clap_subcommand!("notice", "Notice: Hello World"))
		.subcommand(clap_subcommand!("success", "Success: Hello World"))
		.subcommand(clap_subcommand!("task", "Task: Hello World"))
		.subcommand(clap_subcommand!("warning", "Warning: Hello World"))
}
