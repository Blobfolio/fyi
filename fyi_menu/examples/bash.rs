/*!
# FYI Menu: BASH Example

This recreates the BASH completions for FYI. The script code is printed to the
screen as it is rather difficult to "demonstrate" completions, but it would
work!
*/
